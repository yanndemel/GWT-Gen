package com.hiperf.gwtgen.gwtgen.coherence;
...
import com.hiperf.common.ui.server.util.sequence.UuidGenerator;
...
public class CoherenceCacheHelper implements ICoherenceCacheHelper{
	...
	public IdGenerator getSequenceGenerator(SequenceGenerator gene) {
		return new com.hiperf.common.ui.server.util.sequence.SequenceGenerator(
