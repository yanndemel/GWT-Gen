...
import com.hiperf.common.ui.client.widget.PanelResizeListener;
import com.hiperf.common.ui.client.widget.PopupMediator;
import com.hiperf.common.ui.client.widget.ResizePanel;
 ...
 * </dl>
 */
public class ResizePopupPanel extends ResizePanel implements HasAnimation, ICloseablePopupPanel {
  ...
  static class ResizeAnimation extends Animation {
    /**
     * The {@link ResizePopupPanel} being affected.
     */
    private ResizePopupPanel curPanel = null;

    /**
     * Indicates whether or not the {@link ResizePopupPanel} is in the process of
    ...
    /**
     * The offset height and width of the current {@link ResizePopupPanel}.
     */
     ...
     */
    public ResizeAnimation(ResizePopupPanel panel) {
      this.curPanel = panel;
    }
   ...
   */
  private static final String DEFAULT_STYLENAME = "naked-dialogBox";
  ...
  /**
   * The {@link ResizeAnimation} used to open and close the {@link ResizePopupPanel}s.
   */
   ...
   * is shown.
   */
  public ResizePopupPanel() {
    super();
    mainTable = new FlexTable();
    super.getContainerElement().appendChild(mainTable.getElement());
    ...
    addPanelResizedListener(new PanelResizeListener() {
		...
		public void onResized(Integer width, Integer height) {
			getContainerElement().setAttribute("width", width + "px");
			getContainerElement().setAttribute("height", height+"px");
		}
	});
  }
   ...
   *          changes.
   */
  public ResizePopupPanel(boolean autoHide) {
    this();
   ...
   */
  public ResizePopupPanel(boolean autoHide, boolean modal) {
    this(autoHide);
    this.modal = modal;
  }
  ...
  public HandlerRegistration addCloseHandler(CloseHandler<ICloseablePopupPanel> handler) {
   ...
   * to actually attached/detach the {@link ResizePopupPanel} to the page.
   *
  ...
  /**
   * Get the glass element used by this {@link ResizePopupPanel}. The element is not
  ...
  /**
   * Enable or disable animation of the {@link ResizePopupPanel}.
   *
  ...
  /**
   * Register or unregister the handlers used by {@link ResizePopupPanel}.
   */
  private void updateHandlers() {
	...
	@Override
	public void setForceClose(boolean b) {
